 ...
 */
public class muestra_usuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet muestra_usuario</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<p>Usuario: "+ usuarioCorrecto + "</p>");
            out.println("<p>Contraseña: "+ passCorrecto + "</p>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
